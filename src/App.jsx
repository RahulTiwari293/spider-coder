      ...
      <header className="w-full py-12 flex flex-col items-center justify-center relative z-10">
        <div className="w-full max-w-6xl mx-auto flex flex-col items-center">
          ...
          <div className="flex space-x-10 mt-6">
            ...
            <a href="https://github.com/rahultiwari" target="_blank" rel="noreferrer" className="text-blue-400 border-b-2 border-red-500 hover:text-red-400 font-bold text-lg">GitHub</a>
